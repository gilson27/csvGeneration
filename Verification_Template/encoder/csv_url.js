...
console.log("in method  +++++++++++++" + urlObject[uriIndex-1]);
      ...
      case "flags":
        ...
        if(data[k+3] == "POST") {
            ...
            urlObject[uriIndex-2][11] = data[k+2];
            urlObject[uriIndex-1][11] = data[k+4];
            console.log("POST FLAG " + data[k+4] + urlObject[uriIndex-1][11] + urlObject[uriIndex-2][11] + " uri index " + (uriIndex-1));
            k+=4;
        } else {
            urlObject[uriIndex-1][11] = data[k+2];
            if(uriIndex>=788) {
                console.log("uriIndex" +  urlObject[788][11]);
            }
            console.log("GET ALONE POST ALONE"+ urlObject[uriIndex-1][11]);
	...
	if(twiceFlag) {
	  ...
	  urlObject[uriIndex-1][10] = tempChildArray.toString();
	  ...
	  for(var r = 0;r<tempChildArrayLength; ++r) {
	    ...
	    console.log(lastchildArrayCombination.toString());
	      ...
	      tempArrayURL[10] = tempChildArray.toString();
	      tempArrayURL[4] = postCode;
          tempArrayURL[11] = flagCombination.toString();
            ...
            for(var t = s+1; t<tempChildArrayLength; ++t) {
               ...
               flagCombination = flagCombination | (1<<t);
	  ...
	  for(var r = 0;r<tempChildArrayLength; ++r) {
	    ...
	    console.log(lastchildArrayCombination.toString());
	      ...
	      tempArrayURL[10] = tempChildArray.toString();
	      tempArrayURL[4] = postCode;
          tempArrayURL[11] = flagCombination;
	    console.log(tempArrayURL)
            urlObject[uriIndex] = tempArrayURL;
	    console.log(urlObject[uriIndex]);
	    uriIndex++;
...
if(i == tempArray.length)
{
	...
	for(urlIDObjectIndex=0;urlIDObjectIndex<urlObject.length;++urlIDObjectIndex){
	  ...
	  urlIDObject[(tempURL)].childs = urlObject[urlIDObjectIndex][10];
      urlIDObject[(tempURL)].flags  = urlObject[urlIDObjectIndex][11];
	}
