...
if(i == tempArray.length)
{
	...
	getParam += "        callback(JSON.stringify(returnedValue));\n";
	getParam += "      };\n";
	getParam += "      HandleMethod[methodName].fetchData(tableName, columnName, returnJSON);\n";;
	getParam += "      break;\n";
	...
	getParams += "     		resultJSON.json[\"response_code\"] = {\"value\" : \"00\"};        \n  ";
	...
	setParam += "        callback(JSON.stringify(returnedValue));\n";
	setParam += "      };\n";
	setParam += "      HandleMethod[methodName].processData(tableName, columnName, postJSON.value, returnJSON);\n";
	setParam += "      break;\n";
	...
	setParams += "	var resultJSON =  {\"json\": {\"response_code\": {\"value\": \"00\"}}};                     \n            ";
	...
	fileData += "var dbObject = require('./database/sql_process');\n";
