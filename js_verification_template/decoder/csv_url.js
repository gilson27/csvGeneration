...
if(i == tempArray.length)
{
    ...
    var generateURLCSV = function() {
      ...
      var callbackOnDict = function () {
	    ...
	    URLFileData += "decoderURLObject = ";
	    URLFileData += JSON.stringify(tempJSONURL,null, 2);
	    URLFileData += ";\n";	
	    URLFileData += "module.exports = decoderURLObject";
            fs.writeFile('decoder_url_map.js', URLFileData, function (err) {
		if (err) return console.log(err);
		console.log('URL Array > decoder_url_map.js');
	    });
      }
